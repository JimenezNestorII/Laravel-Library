	...
	<div class="container">
		<div class="row">
			<div class="module module-login span8 offset2">
				<form class="form-vertical" action="{{ URL::route('student-registration-post') }}" enctype="multipart/form-data" method="POST">
					...
					<div class="module-body">
						<div class="control-group">
							<div class="controls row-fluid">
								<input type="file" class="span12 @error('img') is-invalid @enderror" name="img" value="{{ old('img') }}"  autocomplete="img">
							</div>
						</div>
						<div class="control-group">
							<div class="controls row-fluid">
