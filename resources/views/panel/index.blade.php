...
<div class="content">
    <div class="btn-controls">
        <div class="btn-box-row row-fluid" >
            <button class="btn-box span12" style="background: #5ca08e; ">
                    ...
                    <form class="form-horizontal row-fluid" id="findbookform">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <div class="span3">
                                    <a class="btn homepage-form-submit " style="background-color:  #5ca08e; color:#fff"><i class="icon-search"></i> Search</a>
                                </div>
                            </div>
                        </div>
                    </form>
